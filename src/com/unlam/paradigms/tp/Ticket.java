	...
	public String toString() {
		...
		if (tourOptions.size() > 0) {
			...
			for (TourismOption tourOption : tourOptions) {
				...
				detail.append("Al precio de: " + tourOption.getAmountToPay() + " oro\n");
				detail.append("Debera tener disponible: " + tourOption.getDuration() + " hora(s).\n");
			}
			detail.append("\nEl tiempo total es: " + String.valueOf(getTotalDuration()) + " hora(s)\n\n");
			detail.append("El costo total es: " + String.valueOf(getTotalAmount()) + " oro\n");
		} else {
